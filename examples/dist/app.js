...
(function($PS) {
  ...
  var upgradeElementsByClassNames = function (classNames) {
  ...
  var upgradeElementByRef = function (dictMonadEffect) {
      return function (ref) {
...
(function($PS) {
  ...
  var Halogen_Query = $PS["Halogen.Query"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  var showDialogByRef = function (dictMonadEffect) {
      return function (ref) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ref))(function (v) {
              if (v instanceof Data_Maybe.Just) {
  ...
  var registerDialogByRef = function (dictMonadEffect) {
      return function (ref) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ref))(function (v) {
              if (v instanceof Data_Maybe.Just) {
  ...
  var closeByRef = function (dictMonadEffect) {
      return function (ref) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ref))(function (v) {
              if (v instanceof Data_Maybe.Just) {
...
(function($PS) {
  ...
  var slider = (function () {
      ...
      var getLowerFraction = function (state) {
          return (state.value - state.min) / (state.max - state.min);
      };
      var getUpperFraction = function (state) {
          return 1.0 - getLowerFraction(state);
      };
      var getBackgroundUpperFlexGrow = function (state) {
          return Data_Int.round(1000.0 * getUpperFraction(state));
      };
      var getBackgroundLowerFlexGrow = function (state) {
...
(function($PS) {
  ...
  var Halogen_Query = $PS["Halogen.Query"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  var showSnackbarWithActionByRef = function (dictMonadEffect) {
      return function (ref) {
  ...
  var showSnackbarNoActionByRef = function (dictMonadEffect) {
      return function (ref) {
          return function (data_) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef(ref))(function (v) {
                  if (v instanceof Data_Maybe.Just) {
...
(function($PS) {
  ...
  var isCurrentTab = function (state) {
      return function (tab) {
  ...
  var demoTabs = (function () {
      ...
      var getActiveClass = function (state) {
          return function (tab) {
      ...
      var renderExampleWithRipple = function (state) {
...
(function($PS) {
  ...
  var bl = {
      ...
      radioGroup: function (groupOptions) {
          var createRadioButton = function (index) {
...
(function($PS) {
  ...
  var routeSignal = function (driver) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(driver.query(Halogen_Query.action(GoTo.create(Route.Home.value))))(function () {
  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Router (line 111, column 12 - line 117, column 14): " + [ v.constructor.name ]);
      };
